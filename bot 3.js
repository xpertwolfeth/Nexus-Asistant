...
bot.on("callback_query", async (q) => {
  ...
  // Переключение режима в группе
  if (d.startsWith("gmode_")) {
    const modeKey = d.replace("gmode_", "");
    const chatId  = q.message.chat.id;
    groupModes[chatId] = modeKey;
    const label = GROUP_MODE_LABEL[modeKey] || modeKey;
    const welcomes = {
      general:    "\U0001F916 *\u0420\u0435\u0436\u0438\u043c \u0411\u0438\u0437\u043d\u0435\u0441*\n\n\u0413\u043e\u0442\u043e\u0432 \u043e\u0442\u0432\u0435\u0447\u0430\u0442\u044c \u043d\u0430 \u0431\u0438\u0437\u043d\u0435\u0441-\u0432\u043e\u043f\u0440\u043e\u0441\u044b. \u0417\u0430\u0434\u0430\u0439\u0442\u0435 \u0432\u043e\u043f\u0440\u043e\u0441!",
      brainstorm: "\U0001F4A1 *\u0420\u0435\u0436\u0438\u043c \u0418\u0434\u0435\u0438*\n\n\u0413\u0435\u043d\u0435\u0440\u0438\u0440\u0443\u044e \u0438\u0434\u0435\u0438. \u041e\u043f\u0438\u0448\u0438\u0442\u0435 \u0437\u0430\u0434\u0430\u0447\u0443!",
      text:       "\u270f\ufe0f *\u0420\u0435\u0436\u0438\u043c \u0422\u0435\u043a\u0441\u0442\u044b*\n\n\u041f\u0438\u0448\u0443 \u0434\u0435\u043b\u043e\u0432\u044b\u0435 \u0442\u0435\u043a\u0441\u0442\u044b. \u0417\u0430\u0434\u0430\u0439\u0442\u0435 \u0437\u0430\u0434\u0430\u0447\u0443!",
      analyst:    "\U0001F4C8 *\u0420\u0435\u0436\u0438\u043c \u0410\u043d\u0430\u043b\u0438\u0442\u0438\u043a*\n\n\u0410\u043d\u0430\u043b\u0438\u0437\u0438\u0440\u0443\u044e \u0434\u0430\u043d\u043d\u044b\u0435 \u0438 \u0440\u044b\u043d\u043a\u0438. \u0417\u0430\u0434\u0430\u0439\u0442\u0435 \u0432\u043e\u043f\u0440\u043e\u0441!",
      law:        "\u2696\ufe0f *\u0420\u0435\u0436\u0438\u043c \u0417\u0430\u043a\u043e\u043d\u044b*\n\n\u041e\u0442\u0432\u0435\u0447\u0430\u044e \u043f\u043e \u0437\u0430\u043a\u043e\u043d\u043e\u0434\u0430\u0442\u0435\u043b\u044c\u0441\u0442\u0432\u0443 \u0420\u0423\u0437. \u0417\u0430\u0434\u0430\u0439\u0442\u0435 \u0432\u043e\u043f\u0440\u043e\u0441!",
      accountant: "\U0001F9EE *\u0420\u0435\u0436\u0438\u043c \u0411\u0443\u0445\u0433\u0430\u043b\u0442\u0435\u0440*\n\n\u0421\u0447\u0438\u0442\u0430\u044e \u043d\u0430\u043b\u043e\u0433\u0438 \u0438 \u0444\u0438\u043d\u0430\u043d\u0441\u044b. \u0417\u0430\u0434\u0430\u0439\u0442\u0435 \u0432\u043e\u043f\u0440\u043e\u0441!",
      time:       "\u23f0 *\u0420\u0435\u0436\u0438\u043c \u0422\u0430\u0439\u043c*\n\n\u041f\u043e\u043c\u043e\u0433\u0430\u044e \u0441 \u043f\u043b\u0430\u043d\u0438\u0440\u043e\u0432\u0430\u043d\u0438\u0435\u043c. \u041f\u0435\u0440\u0435\u0447\u0438\u0441\u043b\u0438\u0442\u0435 \u0437\u0430\u0434\u0430\u0447\u0438!",
    };
    bot.sendMessage(chatId, welcomes[modeKey] || "Режим выбран!", { parse_mode: "Markdown" });
    return;
  }
});
...
// ════════════════════════════════════════════════════════════════
//  ГРУППА — команды и ответы
// ════════════════════════════════════════════════════════════════

// Хранилище текущего режима группы
const groupModes = {}; // { groupId: { mode, botUsername } }

function getGroupMode(groupId) {
  return groupModes[groupId] || "general";
}
...
function groupKb() {
  return {
    reply_markup: {
      inline_keyboard: [
        [{ text: "🤖 Бизнес",   callback_data: "gmode_general"    }, { text: "💡 Идеи",    callback_data: "gmode_brainstorm" }],
        [{ text: "✏️ Тексты",   callback_data: "gmode_text"       }, { text: "📈 Аналитик", callback_data: "gmode_analyst"    }],
        [{ text: "⚖️ Законы",   callback_data: "gmode_law"        }, { text: "🧮 Бухгалтер",callback_data: "gmode_accountant" }],
        [{ text: "⏰ Тайм",     callback_data: "gmode_time"       }],
      ],
    },
  };
}
...
const GROUP_CMD_MAP = {
  ...
  "/text":     "text",      "/matnlar": "text",        "/тексты": "text",
...
const GROUP_MODE_LABEL = {
  general: "🤖 Бизнес", brainstorm: "💡 Идеи", text: "✏️ Тексты",
  analyst: "📈 Аналитик", law: "⚖️ Законы", accountant: "🧮 Бухгалтер", time: "⏰ Тайм",
};
...
async function handleGroupMessage(msg) {
  ...
  if (!groupModes[groupId]) groupModes[groupId] = "general";

  // /menu или /start — показать меню режимов
  if (/^\/(menu|start|help|помощь|yordam)(@\S+)?$/i.test(text)) {
    const info = await bot.getMe();
    bot.sendMessage(groupId,
      "👋 *Бот активен!*\n\nВыберите режим или используйте команды:\n" +
      "/analyst · /business · /ideas · /law · /accountant · /time\n\n" +
      "Затем задайте вопрос — отвечу в группе!",
      { parse_mode: "Markdown", ...groupKb() }
    );
    return;
  }

  // Команды переключения режима
  const cmdBase = text.split("@")[0].toLowerCase().trim();
  if (GROUP_CMD_MAP[cmdBase]) {
    groupModes[groupId] = GROUP_CMD_MAP[cmdBase];
    const label = GROUP_MODE_LABEL[GROUP_CMD_MAP[cmdBase]];
    const welcomes = {
      general:    "🤖 *Режим Бизнес*\n\nГотов отвечать на бизнес-вопросы. Задайте вопрос!",
      brainstorm: "💡 *Режим Идеи*\n\nГенерирую идеи для бизнеса. Опишите задачу!",
      text:       "✏️ *Режим Тексты*\n\nПишу деловые тексты, письма, посты. Задайте задачу!",
      analyst:    "📈 *Режим Аналитик*\n\nАнализирую данные, KPI, рынки. Задайте вопрос!",
      law:        "⚖️ *Режим Законы*\n\nОтвечаю по законодательству Узбекистана. Задайте вопрос!",
      accountant: "🧮 *Режим Бухгалтер*\n\nСчитаю налоги, зарплаты, финансы. Задайте вопрос!",
      time:       "⏰ *Режим Тайм-менеджмент*\n\nПомогаю с планированием. Перечислите задачи!",
    };
    bot.sendMessage(groupId, welcomes[GROUP_CMD_MAP[cmdBase]], { parse_mode: "Markdown" });
    return;
  }

  // /tasks — показать задачи (ищем в личках связанных пользователей)
  if (/^\/tasks(@\S+)?$/i.test(text)) {
    bot.sendMessage(groupId, "📋 Задачи ведутся в личке с ботом. Напишите мне в личку и нажмите 📋 Задачи.", { parse_mode: "Markdown" });
    return;
  }

  // Проверяем упоминание бота или ответ на сообщение бота
  let botInfo;
  try { botInfo = await bot.getMe(); } catch(_) { return; }
  const mentioned   = text.includes("@" + botInfo.username);
  const replyToBot  = msg.reply_to_message?.from?.id === botInfo.id;
  ...
  // Отвечаем используя текущий режим группы
  bot.sendChatAction(groupId, "typing");
  try {
    const mode    = getGroupMode(groupId);
    const sys     = getBaseSystem(mode, "ru");
    const history = [];
    const r = await groq.chat.completions.create({
      model: "llama-3.3-70b-versatile",
      max_tokens: 1000,
      messages: [{ role: "system", content: sys }, { role: "user", content: cleanText }],
    });
    const reply = r.choices[0].message.content;
    // Отвечаем reply на сообщение пользователя
    bot.sendMessage(groupId, reply, {
      parse_mode: "Markdown",
      reply_to_message_id: msg.message_id,
    });
  } catch (e) {
    console.error("Group AI error:", e.message);
    bot.sendMessage(groupId, "❌ Ошибка. Попробуйте ещё раз.", { reply_to_message_id: msg.message_id });
  }
}
